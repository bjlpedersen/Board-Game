...
/**
 * This class represents an Area in the game. An Area is a record that contains a set of zones,
 * a list of occupants, and the number of open connections.
 *
...
public record Area<Z extends Zone>(Set<Z> zones, List<PlayerColor> occupants, int openConnections) {
    ...
    public static final class TilesTest {
        private TilesTest() {
        }

        public static final List<Tile> TILES = myTilesWildFire();
        ...
        private static List<Tile> myTilesShaman() {
            ArrayList<Tile> tiles = new ArrayList<>();
            {   // Tile 56
                var l1 = new Zone.Lake(56_8, 1, null);
                var a0_0 = new Animal(56_0_0, Animal.Kind.AUROCHS);
        ...
        private static List<Tile> myTilesHunting() {
            ArrayList<Tile> tiles = new ArrayList<>();
            {   // Tile 56
                var l1 = new Zone.Lake(56_8, 1, null);
                var a0_0 = new Animal(56_0_0, Animal.Kind.AUROCHS);
        ...
        private static List<Tile> myTilesWildFire() {
            ArrayList<Tile> tiles = new ArrayList<>();
            {   // Tile 56
                var l1 = new Zone.Lake(56_8, 1, null);
                var a0_0 = new Animal(56_0_0, Animal.Kind.AUROCHS);
        ...
        private static List<Tile> myTilesSkipTile() {
            ArrayList<Tile> tiles = new ArrayList<>();
            {   // Tile 35
                var a0_0 = new Animal(35_0_0, Animal.Kind.MAMMOTH);
                var z0 = new Zone.Meadow(35_0, List.of(a0_0), null);
                ...
                var sW = new TileSide.Meadow(z0);
                assert tiles.size() == 35;
                tiles.add(new Tile(35, Tile.Kind.START, sN, sE, sS, sW));
            }
            {   // Tile 13
                var l1 = new Zone.Lake(13_8, 2, null);
                var a0_0 = new Animal(13_0_0, Animal.Kind.DEER);
